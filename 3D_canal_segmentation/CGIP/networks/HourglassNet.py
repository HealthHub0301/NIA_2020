...
class HourglassNet(nn.Module):
    ...
    def __init__(self, block, in_channels, num_stacks=2, num_blocks=4, num_classes=16):
        ...
        self.linear = nn.Linear(256, num_classes * 2)
...
def hourglass(num_classes, in_channels=1):
...
if __name__ == "__main__":
    ...
    model = hourglass(2, in_channels=257)
    model.cuda()

    summary(model, (257, 128, 128))
